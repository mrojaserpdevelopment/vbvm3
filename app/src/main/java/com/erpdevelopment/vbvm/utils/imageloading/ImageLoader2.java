...
public class ImageLoader2 {
    ...
    public ImageLoader2(Activity activity){
...
//        Bitmap bitmap = memoryCache.get(url);
        ...
        else
        {
            ...
            //Before IS_SERVICE_RUNNING image show default image
            //imageView.setImageResource(stub_id);
            BitmapManager2.setImageBitmap(activity, imageView, R.drawable.image_placeholder);
        }
    }
...
//        Bitmap b = decodeFile(f);
        Bitmap b = BitmapManager2.getBitmapFromFile(f);
        if( b != null )
            return b;
...
//            bitmap = decodeFile(f);
            ...
            bitmap = BitmapManager2.getBitmapFromFile(f);
