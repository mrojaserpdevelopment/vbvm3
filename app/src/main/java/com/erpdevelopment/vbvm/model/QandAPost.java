...
public class QandAPost implements Parcelable{
	 ...
	 */
	public QandAPost(Parcel in) {
		readFromParcel(in);
	}

	public static final Parcelable.Creator<QandAPost> CREATOR =
		    	new Parcelable.Creator<QandAPost>() {
		            public QandAPost createFromParcel(Parcel in) {
		                return new QandAPost(in);
		            }
		 
		            public QandAPost[] newArray(int size) {
		                return new QandAPost[size];
		            }
		        };
