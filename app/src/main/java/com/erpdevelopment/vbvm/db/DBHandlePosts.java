...
public class DBHandlePosts {
	...
	public static List<QandAPost> getAllPosts(boolean limitCount) {
	    String selectQuery;
		if (limitCount)
    	...
    	List<QandAPost> posts = new ArrayList<QandAPost>();
    	QandAPost post = null;	    
	    if (c.moveToFirst()) {
	        do {
	        	post = new QandAPost();				
	...
	public static QandAPost getPostById(String idPost) {
